				...
				<div class="col-md-10">
					...
					<c:forEach items="${hosts}" var="p">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<div style="height: 40px;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;overflow: hidden;">
							<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${p.pid}" style='color:#666'>${p.pname}</a></p>
							</div>
							<p><font color="#E4393C" style="font-size:16px">&yen; <fmt:formatNumber value=" ${ p.shop_price }" pattern="#.00"/></font></p>
						</div>
					</c:forEach>
