		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${order.list}" var="v">


							<tr class="active">
								<td width="60" width="40%">
									<input type="hidden" name="id" value="22">
									<img src="${pageContext.request.contextPath}/${v.product.pimage}" width="70" height="60">
								</td>
								<td width="30%">
									<a target="_blank"> ${v.product.pname}</a>
								</td>
								<td width="20%">
									￥
									<fmt:formatNumber value="${v.product.shop_price}" pattern="#.00"/>
								</td>
								<td width="10%">
										${v.quantity}
								</td>
								<td width="15%">
									<span class="subtotal">￥ <fmt:formatNumber value=" ${v.total}" pattern="#.00"/></span>
								</td>
				...
				<div style="text-align:right;margin-right:120px;">
					商品金额: <strong style="color:#ff6600;">￥ <fmt:formatNumber value=" ${order.total}" pattern="#.00"/>元</strong>
				</div>
			...
			<div>
				<hr/>
				<form class="form-horizontal" id="orderForm" method="post" action="${pageContext.request.contextPath}/OrderServlet?method=payOrder01"  style="margin-top:5px;margin-left:150px;">
